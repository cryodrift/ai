...
$modelproviders = [
  new Provider('oairesp', 'https://api.openai.com/v1/responses', Core::env('AI_APIKEY_OPENAI'), modelsurl: 'https://api.openai.com/v1/models', payload: 'hug'),
...
$cfg[ParamProvider::class] = [
  'providers' => [
    ...
    new Provider('cldresp', 'https://api.anthropic.com/v1/messages', Core::env('AI_APIKEY_CLD'), ['x-api-key' => Core::env('AI_APIKEY_CLD'), 'anthropic-version' => '2023-06-01'], modelsurl: Core::env('AI_MODELURL_CLD'), payload: 'hug'),
    ...$modelproviders
  ]
];
